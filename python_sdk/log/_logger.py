...
class _Config:
    LOG_LEVEL: config.Choice["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"] = "INFO"
    LOG_OUTPUT_STYLE: config.Choice["MACHINE_READABLE", "HUMAN_READABLE"] = "MACHINE_READABLE"
    LOG_DESTINATION: config.Choice["STDOUT", "STDERR", "ROTATING_FILE"] = "STDOUT"
