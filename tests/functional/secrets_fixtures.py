...
@pytest.fixture(scope="function")
def aws_ps_client(configure_aws_ps_secrets_engine: None) -> object:
    return boto3.client(
        service_name="ssm",
        aws_access_key_id="fake",
        aws_secret_access_key="fake",
...
@pytest.fixture(scope="function")
def random_aws_ps_secret_string(aws_ps_client: object) -> typing.Generator[tuple[str, str], None, None]:
    name, value = str(uuid.uuid4()), str(uuid.uuid4())
...
@pytest.fixture(scope="function")
def random_aws_ps_secret_string_list(aws_ps_client: object) -> typing.Generator[tuple[str, str], None, None]:
    name, value = str(uuid.uuid4()), [str(uuid.uuid4()), str(uuid.uuid4())]
...
@pytest.fixture(scope="function")
def random_aws_ps_secret_json(aws_ps_client: object) -> typing.Generator[tuple[str, str], None, None]:
    name, value = str(uuid.uuid4()), {str(uuid.uuid4()): str(uuid.uuid4())}
