...
@pytest.mark.parametrize(
    ...
    [
        ...
        # str_to_choice
        ("INFO", _config_decoder.Choice["INFO"], "INFO"),
        ("DEBUG", _config_decoder.Choice["INFO", "DEBUG"], "DEBUG"),
        ("info", _config_decoder.Choice["INFO"], ValueError),
        ("", _config_decoder.Choice["INFO"], ValueError),
        (None, _config_decoder.Choice["INFO"], ValueError),
        # str_to_list_of_strs
        ...
        (", ", typing.List[_config_decoder.Base64EncodedString], ValueError),
        (" , ", typing.List[_config_decoder.Base64EncodedString], ValueError),
        # str_to_list_of_choices
        ("INFO", typing.List[_config_decoder.Choice["INFO"]], ["INFO"]),
        ("DEBUG", typing.List[_config_decoder.Choice["INFO", "DEBUG"]], ["DEBUG"]),
        ("INFO,DEBUG", typing.List[_config_decoder.Choice["INFO", "DEBUG"]], ["INFO", "DEBUG"]),
        ("info", typing.List[_config_decoder.Choice["INFO"]], ValueError),
        ("INFO,", typing.List[_config_decoder.Choice["INFO"]], ValueError),
        ("INFO ", typing.List[_config_decoder.Choice["INFO"]], ValueError),
        (",INFO ", typing.List[_config_decoder.Choice["INFO"]], ValueError),
        (" INFO ", typing.List[_config_decoder.Choice["INFO"]], ValueError),
        ("", typing.List[_config_decoder.Choice["INFO"]], ValueError),
        (None, typing.List[_config_decoder.Choice["INFO"]], ValueError),
        # str_to_optional_str
        ...
        ("dGVzdA== ", typing.Optional[_config_decoder.Base64EncodedString], ValueError),
        # str_to_optional_choice
        ("INFO", typing.Optional[_config_decoder.Choice["INFO"]], "INFO"),
        ("DEBUG", typing.Optional[_config_decoder.Choice["INFO", "DEBUG"]], "DEBUG"),
        ("", typing.Optional[_config_decoder.Choice["INFO"]], None),
        (None, typing.Optional[_config_decoder.Choice["INFO"]], None),
        ("info", typing.Optional[_config_decoder.Choice["INFO"]], ValueError),
        ...
        # str_to_optional_list_of_choices
        ("INFO", typing.Optional[typing.List[_config_decoder.Choice["INFO"]]], ["INFO"]),
        ("DEBUG", typing.Optional[typing.List[_config_decoder.Choice["INFO", "DEBUG"]]], ["DEBUG"]),
        (
            "INFO,DEBUG",
            typing.Optional[typing.List[_config_decoder.Choice["INFO", "DEBUG"]]],
            ["INFO", "DEBUG"],
        ),
        ("", typing.Optional[typing.List[_config_decoder.Choice["INFO"]]], None),
        (None, typing.Optional[typing.List[_config_decoder.Choice["INFO"]]], None),
        ("info", typing.Optional[typing.List[_config_decoder.Choice["INFO"]]], ValueError),
        ("INFO,", typing.Optional[typing.List[_config_decoder.Choice["INFO"]]], ValueError),
        ("INFO ", typing.Optional[typing.List[_config_decoder.Choice["INFO"]]], ValueError),
        (",INFO ", typing.Optional[typing.List[_config_decoder.Choice["INFO"]]], ValueError),
        (" INFO ", typing.Optional[typing.List[_config_decoder.Choice["INFO"]]], ValueError),
